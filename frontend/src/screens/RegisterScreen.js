...
const RegisterScreen = ({ navigation }) => {
  ...
  const handleRegister = async () => {
    ...
    if (!result.success) {
      ...
      Alert.alert(
        'Welcome! 🎉',
        'Your account has been created successfully. You will receive notifications for your orders and exclusive offers!',
        [{ text: 'OK' }]
      );
    }
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.notificationInfo}>
            <Icon name="notifications-active" size={20} color="#2874f0" />
            <Text style={styles.notificationText}>
              Get instant updates on orders & exclusive deals via push notifications
            </Text>
          </View>
